...
//         outputs: {
//           'foo.exported.json': [
//             ...LegacyExport.element(uri: uri('foo.dart'), name: 'Foo'),
//             ...LegacyExport.element(uri: uri('foo.dart'), name: 'foo'),
//           ],
//           'bar.exported.json': [
//             ...LegacyExport.element(uri: uri('bar.dart'), name: 'Bar'),
//             ...LegacyExport.element(uri: uri('bar.dart'), name: 'bar'),
//           ],
//         },
//       );
...
//         outputs: {
//           'foo.exported.json': [
//             ...LegacyExport.element(uri: uri('foo.dart'), name: 'Foo', tags: ['foo', 'bar']),
//             ...LegacyExport.element(uri: uri('foo.dart'), name: 'foo', tags: ['foo']),
//           ],
//           'bar.exported.json': [
//             ...LegacyExport.element(uri: uri('bar.dart'), name: 'Bar', tags: ['foo', 'bar']),
//             ...LegacyExport.element(uri: uri('bar.dart'), name: 'bar', tags: ['foo']),
//           ],
//         },
//       );
//
...
//           ],
//           'bar.exported.json': [
//             ...LegacyExport.library(uri: uri('bar.dart'), tags: ['foo', 'bar']),
//           ],
//         },
//       );
//     });
